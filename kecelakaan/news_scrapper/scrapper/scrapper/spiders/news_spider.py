...
class NewsSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        "https://www.detik.com/search/searchall?query=kecelakaan%20tabrakan&sortby=time&sorttime=2&fromdatex=02/07/2022&todatex=03/07/2022&page=1"
    ]
    ...
    def spider_closed(self, spider):
        ...
        writer.to_csv('scrapped_news3_7.csv', index=False, sep=',')
